...
public class UpdateFeesDetails extends javax.swing.JFrame {
    ...
    public boolean validation(){
       ...
       if(txtAmountFirst.getText().equals("")){
   ...
   public void fillComboBox(){
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        if(validation() == true){
           ...
           if(result.equals("Success")){
            JOptionPane.showMessageDialog(this, "Records Update SuccessFully");
            printReceipt p =new printReceipt();
            p.setVisible(true);
            this.dispose();
           }
           else{
              JOptionPane.showMessageDialog(this, "Records Update Failed"); 
           }
        }
    ...
    try{
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/fees_managment?zeroDateTimeBehavior=CONVERT_TO_NULL","root","");  
        PreparedStatement pst=con.prepareStatement("update  fees_details set studentName=?,rollNo=?,paymentMode=?,chequeNo=?,bankName=?,ddNo=?,courseName=?,gstin=?,totalAmount=?,date=?,amount=?,cgst=?,sgst=?,totalInWords=?,remark=?,year1=?,year2=? where recieptNo=?");
    ...
    public void setRecords(){
       ...
       PreparedStatement pst=con.prepareStatement("SELECT * FROM fees_details ORDER BY recieptNo DESC LIMIT 1");
        ResultSet rs=pst.executeQuery();
        rs.next();
        txtReceiptNo.setText(rs.getString("recieptNo"));
        comboBoxPayment.setSelectedItem(rs.getString("paymentMode"));
        txtChequeNo.setText(rs.getString("chequeNo"));
        txtDDNo.setText(rs.getString("ddNo"));
        txtBankName1.setText(rs.getString("bankName"));
        txtHead.setText(rs.getString("studentName"));
        DateChosser.setDate(rs.getDate("date"));
        txtFirstDate.setText(rs.getString("year1"));
        txtLastDate.setText(rs.getString("year2"));
        comboBoxCourse1.setSelectedItem(rs.getString("courseName"));
        txtAmountFirst.setText(rs.getString("amount"));
        txtCgst.setText(rs.getString("cgst"));
        txtSgst.setText(rs.getString("sgst"));
        txtSumTotal.setText(rs.getString("totalAmount"));
        txtTotalInWords.setText(rs.getString("totalInWords"));
        txtRollNo.setText(rs.getString("rollNo"));
        textPaneRemark.setText(rs.getString("remark"));
        }catch(Exception e){
            e.printStackTrace();
        }
    }
